...
## Get NLCD data
In this example we access National Land Cover Dataset (NLCD) data for 2001, just at the catchment level for several COMIDs using the `sc_get_nlcd` function.  Loads data into a tibble we can view.
```{r get_nlcd}
