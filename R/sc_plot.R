#' @title Plot National Nutrient Inventory data for streams
#'
#' @description 
...
#' Selia Markley
#'
#' @param comid Identifier of stream COMID user wants to plot NNI data for. Must be a character string
